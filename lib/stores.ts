...
export const STORES: Record<StoreId, Store> = {
  tesco: {
    ...
    minBasketPence: 4000,
    searchUrlPattern: "https://www.tesco.com/groceries/en-GB/search?query={query}",
    milesAway: 1.2,
    travelMinutes: 7,
  },
  sainsburys: {
    ...
    minBasketPence: 4000,
    searchUrlPattern: "https://www.sainsburys.co.uk/gol-ui/SearchResults/{query}",
    milesAway: 1.8,
    travelMinutes: 9,
  },
  asda: {
    ...
    minBasketPence: 4000,
    searchUrlPattern: "https://groceries.asda.com/search/{query}",
    milesAway: 2.6,
    travelMinutes: 12,
  },
  morrisons: {
    ...
    deliveryFeePence: 400,
    minBasketPence: 2500,
    searchUrlPattern: "https://groceries.morrisons.com/search?entry={query}",
    milesAway: 3.1,
    travelMinutes: 14,
  },
  aldi: {
    ...
    searchUrlPattern: "https://groceries.aldi.co.uk/en-GB/Search?keywords={query}",
    milesAway: 2.2,
    travelMinutes: 11,
  },
  lidl: {
  ...
  waitrose: {
    ...
    minBasketPence: 6000,
    searchUrlPattern: "https://www.waitrose.com/ecom/shop/search?searchTerm={query}",
    milesAway: 4.4,
    travelMinutes: 18,
  },
  iceland: {
    ...
    deliveryFeePence: 0,
    minBasketPence: 4000,
    searchUrlPattern: "https://www.iceland.co.uk/search?q={query}",
    milesAway: 1.5,
    travelMinutes: 8,
  },
  coop: {
    ...
    searchUrlPattern: "https://shop.coop.co.uk/search?q={query}",
    milesAway: 0.6,
    travelMinutes: 4,
  },
};
